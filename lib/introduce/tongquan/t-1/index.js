$(function() {
    if ($('.canhcam-introduce-detail-1 .carousel-1').length) {
        $('.canhcam-introduce-detail-1 .carousel-1').owlCarousel({
            animateIn: 'fadeIn',
            animateOut: 'fadeOut',
            items: 2,
            loop: true,
    ...
    $('.canhcam-introduce-detail-1 .carousel-1 .item').on('click', function() {
